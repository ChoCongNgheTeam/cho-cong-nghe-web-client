      ...
      <div className="bg-neutral-light rounded-xl border border-neutral px-4 py-3 shadow-sm h-full flex flex-col">
         ...
         <div className="space-y-1.5 flex-1">
            {STEPS.map((step) => {
               ...
               const base =
                  step.key === "requested"
                     ? Math.max(data.requested + totalOrders, 1)
                     : total;
               ...
               return (
                  <div key={step.key} className="flex items-center gap-2">
                     <div className="w-20 shrink-0">
                        <span className="text-[10px] text-primary truncate block leading-tight">
                           {step.label}
                        </span>
                     </div>
                     ...
                     <div className="w-12 text-right shrink-0">
                        ...
                        <span className="text-[9px] text-neutral-dark ml-1">
                           {pct}%
                        </span>
                     </div>
                  </div>
         ...
         <div className="mt-2 pt-2 border-t border-neutral grid grid-cols-2 gap-x-3 gap-y-0.5">
            <div className="flex justify-between items-center">
               ...
               <span className="text-[10px] font-semibold text-promotion">
                  {total > 0
