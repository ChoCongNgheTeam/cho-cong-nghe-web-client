...
/* ─── style ─── */
const cls = {
   input: "w-full rounded-xl border border-neutral bg-neutral-light px-3.5 py-2.5 text-sm text-primary placeholder:text-neutral-dark focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent/50 transition-colors",
   inputErr:
   ...
   readonly:
      "w-full rounded-xl border border-neutral bg-neutral-light-active px-3.5 py-2.5 text-sm text-primary/60 cursor-not-allowed",
};
...
const isValidPhone = (p: string) =>
   p === "" || /^(\+84|0)[0-9]{8,10}$/.test(p.replace(/\s/g, ""));
...
function PwdReq({ met, text }: { met: boolean; text: string }) {
   return (
      <div className="flex items-center gap-2 text-xs">
         ...
         <span className={met ? "text-green-600" : "text-neutral-dark"}>
            {text}
         </span>
      </div>
   );
...
export default function AccountView() {
   ...
   const validateProfile = () => {
      ...
      if (dobFilled > 0 && dobFilled < 3)
         errs.dob = "Vui lòng chọn đầy đủ ngày, tháng, năm";
      else if (dobFilled === 3) {
   ...
   const validatePassword = () => {
      ...
      if (!pwd.newPassword) errs.newPassword = "Vui lòng nhập mật khẩu mới";
         ...
         errs.newPassword = "Tối thiểu 8 ký tự";
   ...
   if (!user)
      return (
         <div className="rounded-2xl border border-neutral bg-neutral-light p-6 text-sm text-primary">
            Bạn chưa đăng nhập
         </div>
      );
   ...
   return (
      <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
               ...
               <div className="flex-1 w-full space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                     ...
                     <span className="inline-flex items-center rounded-full bg-green-500/10 px-3 py-1 text-xs font-semibold text-green-600">
                        Đang hoạt động
                     </span>
                  </div>
         ...
         <Card
            ...
            desc="Cập nhật thông tin liên hệ và chi tiết cá nhân"
         >
               ...
               <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                     ...
                     <input
                        ...
                        className={
                           profileErrors.fullName ? cls.inputErr : cls.input
                        }
                     />
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={
                           profileErrors.phone ? cls.inputErr : cls.input
                        }
                     />
                  ...
                  <div className="grid grid-cols-3 gap-2">
                     {(
                        ...
                        <div key={field} className="relative">
                           <select
                              value={dob[field]}
                              onChange={(e) => handleDob(field, e.target.value)}
                              className={`${cls.select} pr-8 text-sm ${profileErrors.dob ? "border-promotion" : ""}`}
                           >
               ...
               <div className="flex justify-end pt-1">
                  <button
                     ...
                     className={[
                        ...
                        isDirty && !saving
                           ? "bg-accent text-white hover:bg-accent/90 shadow-sm active:scale-95 cursor-pointer"
                           : "bg-neutral text-neutral-dark cursor-not-allowed opacity-60",
                     ].join(" ")}
                  >
                     {saving ? (
                        <>
               ...
               {pwd.newPassword.length > 0 && (
                  <div className="space-y-2.5 p-4 rounded-xl border border-neutral bg-neutral-light-active/50">
                     <div className="flex items-center justify-between text-xs">
                        ...
                        <span className={`font-bold ${strengthBar.text}`}>
                           {strengthBar.label}
                        </span>
                     </div>
         ...
         <div className="grid gap-6 lg:grid-cols-2">
            <Card
               ...
               desc="Bảo vệ tài khoản với mã xác thực"
            >
                  ...
                  {!twoFaSms && !twoFaEmail && (
                     <div className="flex gap-2 rounded-xl border border-amber-300/50 bg-amber-50 dark:bg-amber-950/20 px-4 py-3">
                        ...
                        <p className="text-xs text-amber-700 dark:text-amber-400">
                           Bật ít nhất một phương thức 2FA.
                        </p>
                     </div>
                  )}
               </div>
            ...
            <Card
               ...
               desc="Quản lý các phiên đang hoạt động"
            >
               <div className="space-y-3">
                  {devices.map((d) => (
                     <div
                     ...
                     >
                        <div className="flex items-start gap-3 min-w-0">
                           <Smartphone
                              className={`h-4 w-4 mt-0.5 shrink-0 ${d.current ? "text-accent" : "text-neutral-dark"}`}
                           />
         ...
         <Card
            ...
            desc="Theo dõi các lần đăng nhập gần đây"
         >
            <div className="rounded-xl border border-neutral overflow-hidden divide-y divide-neutral">
               {loginHistory.map((h) => (
                  <div
                     key={h.id}
                     className="flex flex-wrap sm:flex-nowrap items-center gap-3 px-4 py-3"
                  >
                     <span
                        className={[
                     ...
                     <div className="text-right shrink-0">
                        ...
                        <p
                           className={`text-[10px] font-semibold mt-0.5 ${h.success ? "text-green-600" : "text-red-500"}`}
                        >
