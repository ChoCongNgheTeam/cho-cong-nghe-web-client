         ...
         >
            <div className="flex items-center gap-1.5">
               ...
               <input
                  ...
                  className={`w-[44px] px-1 py-0.5 text-[11px] text-center border rounded-md ml-auto tabular-nums
                     ...
                     ${
                        hasAdd
                           ? "border-accent bg-accent-light/30 text-accent-dark focus:border-accent"
                           : "border-neutral bg-neutral-light focus:bg-neutral-light focus:border-primary"
                     }`}
               />
            </div>
            ...
            {hasAdd && (
               <div className="flex items-center gap-1 pt-0.5 border-t border-accent/20">
                  ...
                  <span className="text-[9px] text-accent/70 ml-auto tabular-nums">
                     +{addNum}
                  </span>
               </div>
            )}
               ...
               <button
                  ...
                  onClick={() => {
                     selectedKeys.forEach((k) =>
                        onUpdate(k, "addQuantity", bulkQty),
                     );
                     setBulkQty("");
                  }}
            ...
            <table className="w-full border-collapse" style={{ minWidth: 580 }}>
               <thead>
                  <tr className="bg-neutral-light-active border-b border-neutral">
                     ...
                     <th className="px-3 py-2.5 text-left text-[10px] font-bold text-neutral-dark uppercase tracking-wider w-[110px]">
                        Tồn kho
                     </th>
                        ...
                        >
                           ...
                           <td className="px-3 py-2">
                              <QuantityCell
                                 ...
                                 onChangeAdd={(val) =>
                                    onUpdate(v._key, "addQuantity", val)
                                 }
                              />
                           </td>
                  ...
                  >
                     <div className="flex items-center justify-between px-3 py-2 bg-neutral-light-active border-b border-neutral">
                        <div className="flex items-center gap-2 flex-1 min-w-0">
                           ...
                           {ci.color && label && (
                              <span className="text-[10px] text-neutral-dark font-mono shrink-0">
                                 {ci.color}
                              </span>
                           )}
                           ...
                           {toDeleteCount > 0 && (
                              <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-promotion-light text-promotion font-semibold shrink-0">
                                 −{toDeleteCount}
                              </span>
                           )}
                           {newCount > 0 && (
                              <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-primary text-neutral-light font-semibold shrink-0">
                                 +{newCount}
                              </span>
                           )}
                        </div>
                           ...
                           <div className="grid grid-cols-2 gap-2 pb-2 border-b border-neutral">
                              ...
                              {ci.color && (
                                 <button
                                    type="button"
                                    onClick={() => toggleEditColor(ci._key)}
                                    className="col-span-2 text-[11px] text-neutral-dark hover:text-primary transition-colors cursor-pointer text-left"
                                 >
                                    ✓ Đóng chỉnh sửa màu
                                 </button>
                              )}
