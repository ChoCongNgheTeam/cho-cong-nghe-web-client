      ...
      <div className="bg-neutral-light border border-neutral rounded-2xl p-5 shadow-sm relative overflow-hidden">
         ...
         {children ?? (
            <>
               ...
               <p className="text-xs text-neutral-dark font-medium mt-0.5">{title}</p>
               <div className="flex items-center gap-1.5 mt-3">
                  ...
                  {sub && <span className="text-xs text-neutral-dark">{sub}</span>}
               </div>
            </>
         )}
      </div>
...
function RatingCircle({ value }: { value: number }) {
   ...
   return (
      <div className="flex items-center justify-center relative w-14 h-14">
         ...
         <span className="text-sm font-bold text-primary relative z-10">{value.toFixed(1)}</span>
      </div>
   );
}
...
function ProductRow({
   ...
   return (
      <tr className="border-b border-neutral hover:bg-neutral-light-hover transition-colors group">
         ...
         <td className="py-3.5 px-4">
            <div className="flex items-center gap-3">
               ...
               <div className="min-w-0">
                  <p className="text-sm font-medium text-primary truncate max-w-[180px]">{product.name}</p>
         ...
         <td className="py-3.5 px-4">
            <span className="text-xs text-neutral-dark bg-neutral px-2 py-1 rounded-lg">Điện thoại</span>
         </td>
         <td className="py-3.5 px-4 text-sm font-semibold text-primary whitespace-nowrap">
            {fmt(product.priceOrigin)}
         </td>
         <td className="py-3.5 px-4 text-sm text-primary-light text-center font-medium">8</td>
         <td className="py-3.5 px-4 text-sm text-neutral-dark text-center">0.00</td>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
               ...
               <StatCard title="">
                  <div className="flex items-center justify-between">
                     <div>
                        <p className="text-3xl font-bold text-primary tracking-tight">5,0/5.0</p>
                        <p className="text-xs text-neutral-dark font-medium mt-0.5">Điểm trung bình</p>
                        <div className="flex items-center gap-0.5 mt-2">
                           ...
                           <span className="text-xs text-green-600 font-medium ml-1.5">↑ Chất lượng tốt</span>
                        </div>
                     </div>
            ...
            <div className="bg-neutral-light border border-neutral rounded-2xl shadow-sm overflow-hidden">
               ...
               <div className="flex items-end justify-between gap-4 flex-wrap px-5 pt-4 border-b border-neutral">
                  ...
                  <div className="flex items-center gap-2 pb-3">
                     ...
                     <button className="flex items-center gap-1.5 px-3 py-2 text-xs text-primary-light border border-neutral rounded-xl hover:bg-neutral-light-active transition-colors font-medium">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                        </svg>
                        Bộ lọc
                     </button>
                     <button className="flex items-center gap-1.5 px-3 py-2 text-xs text-primary-light border border-neutral rounded-xl hover:bg-neutral-light-active transition-colors font-medium whitespace-nowrap">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        Lọc theo ngày
                     </button>
                     <button className="flex items-center gap-1.5 px-3 py-2 text-xs text-primary-light border border-neutral rounded-xl hover:bg-neutral-light-active transition-colors">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
               ...
               <div className="overflow-x-auto">
                  {error ? (
                     <div className="flex flex-col items-center py-16 gap-2">
                        ...
                        <button onClick={fetchProducts} className="text-xs text-accent hover:underline">Thử lại</button>
                     </div>
                  ) : (
                     <table className="w-full text-left">
                        <thead>
                           <tr className="border-b border-neutral bg-neutral-light-active/60">
                              ...
                              <TH>Tổng giá trị</TH>
                              <TH>Trạng thái</TH>
                              <th className="py-3 px-4 text-xs font-semibold text-neutral-dark">Hành động</th>
                           </tr>
                        </thead>
                        <tbody>
                           {loading
                              ...
                              ? (
                                 <tr>
                                    <td colSpan={9} className="py-16 text-center text-sm text-neutral-dark">
