            ...
            <tbody>
              {loading ? (
                ...
                orders.map((order, idx) => {
                  ...
                  const isHighlighted = !!highlightCode && order.orderCode === highlightCode;
                    ...
                    >
                      ...
                      <td className="px-3 py-2.5">
                        <PaymentMethodCell
                          ...
                          onMethodChange={(newMethod) => handlePaymentMethodChange(order.id, newMethod)}
                        />
                      </td>
                      <td className="px-3 py-2.5">
                      ...
                      <td className="px-3 py-2.5">
                        {order.paymentStatus === "REFUND_PENDING" || order.orderStatus === "DELIVERED" ? (
