...
export default function OrdersPage() {
   ...
   useEffect(() => {
      ...
      requestAnimationFrame(() => {
         const el = document.getElementById(`admin-order-row-${target.id}`);
   ...
   useEffect(() => {
      const wasOnDetail =
         ...
         prevPathname.current.startsWith("/admin/orders/");
      prevPathname.current = pathname;
   ...
   return (
      <div className="space-y-5 p-5 bg-neutral-light h-full">
         ...
         <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <StatsCard
               label="Tổng đơn hàng"
               value={globalCounts.ALL ?? 0}
               sub="Tất cả đơn trong hệ thống"
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-neutral gap-4 flex-wrap">
               ...
               <div className="flex items-center gap-1 flex-wrap">
                  {STATUS_TABS.map((tab) => (
                     ...
                     >
                        {tab.label}
                        <span
                           className={`ml-1.5 px-1.5 py-0.5 rounded-md text-[10px] font-semibold ${activeTab === tab.value ? "bg-white/20 text-white" : "bg-neutral-light-active text-primary"}`}
                        >
               ...
               <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <div className="absolute top-full left-0 mt-1.5 w-48 bg-neutral-light border border-neutral rounded-xl shadow-lg z-20 overflow-hidden">
                           ...
                           {PAYMENT_STATUS_OPTIONS.map((opt) => (
                              <button
                                 key={opt.value}
                                 onClick={() =>
                                    handlePaymentFilterChange(opt.value)
                                 }
                        ...
                        <div className="absolute top-full right-0 mt-1.5 w-72 bg-neutral-light border border-neutral rounded-xl shadow-lg z-20 p-4 space-y-3">
                           ...
                           <div className="flex gap-2 pt-1">
                              <button
                                 ...
                                 className="flex-1 py-1.5 rounded-lg border border-neutral text-[12px] text-primary hover:bg-neutral-light-active transition-all cursor-pointer"
                              >
                                 Xóa
                              </button>
                              <button
                                 onClick={handleApplyDate}
                                 className="flex-1 py-1.5 rounded-lg bg-accent text-white text-[12px] font-medium hover:bg-accent-hover transition-all cursor-pointer"
                              >
                                 Áp dụng
                              </button>
                           </div>
                  ...
                  <ExportButton
                     ...
                     onSuccess={(count, fmt) =>
                        toast.success(
                           `Đã export đơn hàng dạng ${fmt.toUpperCase()}`,
                        )
                     }
                     ...
                     {loading ? (
                        ...
                        orders.map((order, idx) => {
                           ...
                           return (
                            ...
                            ${
                               isHighlighted
                                  ? "bg-accent/10 shadow-[inset_0_0_0_2px_var(--color-accent)]"
                                  : "hover:bg-neutral-light-active/60"
                            }
                          `}
                              >
               ...
               <div className="flex flex-col gap-3 pt-1">
                  ...
                  <div>
                     ...
                     <p className="text-[13px] text-primary leading-relaxed">
                        Đơn hàng sẽ bị hủy và tồn kho sẽ được hoàn lại. Bạn có
