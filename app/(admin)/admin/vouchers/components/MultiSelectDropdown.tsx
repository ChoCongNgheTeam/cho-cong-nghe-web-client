    ...
    <div className="flex items-center gap-2.5 py-0.5">
      <div className="shrink-0 w-8 h-8 rounded-md overflow-hidden border border-neutral bg-white flex items-center justify-center">
        {data.thumbnail ? (
          ...
          <img src={data.thumbnail} alt={data.label} className="w-full h-full object-contain" />
        ) : (
      ...
      <div className="flex-1 min-w-0">
        ...
        {data.meta && <p className="text-[11px] text-neutral-darker truncate leading-tight">{data.meta}</p>}
      </div>
...
export function SingleProductSearch({ value, onChange, onSearch, placeholder = "Tìm tên sản phẩm, SKU...", isDisabled = false }: SingleProductSearchProps) {
