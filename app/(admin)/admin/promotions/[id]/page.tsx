...
import {
   ...
   getPromotionStatus,
} from "../components/PromotionStatusBadge";
import {
   PromotionForm,
   promotionToForm,
   formToPayload,
   ...
   return (
      <div className="min-h-screen bg-neutral-light">
         ...
         <div className="flex items-center gap-3 px-6 pt-5 pb-3">
            ...
            <span className="text-neutral-dark text-[13px]">/</span>
            <span className="text-[13px] text-primary font-medium truncate max-w-xs">
               {promotion.name}
            </span>
         </div>
               ...
               <div className="w-64 shrink-0 space-y-4">
                  ...
                  <div className="bg-neutral-light border border-neutral rounded-xl p-4 space-y-2">
                     ...
                     <div className="text-[12px] space-y-1.5">
                        <div>
                           <span className="text-neutral-dark block">
                              Bắt đầu
                           </span>
                        ...
                        <div>
                           ...
                           <span
                              className={`font-medium ${status.value === "expired" ? "text-promotion" : "text-primary"}`}
                           >
                              {promotion.endDate
               ...
               <div className="flex-1 min-w-0 space-y-4">
                  ...
                  <div className="bg-neutral-light border border-neutral rounded-xl px-5 py-4 flex items-start justify-between gap-4">
                     <div className="flex-1 min-w-0">
                        <h1 className="text-[20px] font-bold text-primary truncate">
                           {promotion.name}
                        </h1>
                     ...
                     <>
                        ...
                        <div className="bg-neutral-light border border-neutral rounded-xl overflow-hidden">
                           <div className="flex items-center gap-2 px-5 py-3.5 border-b border-neutral">
                              ...
                              <span className="text-[12px] font-semibold text-neutral-dark uppercase tracking-wider">
                                 Quy tắc ưu đãi ({promotion.rules.length})
                              </span>
                           </div>
                           <div className="p-5 space-y-3">
                              {promotion.rules.length === 0 ? (
                                 <p className="text-[13px] text-neutral-dark italic">
                                    Chưa có rule nào
                                 </p>
                              ) : (
                                 promotion.rules.map((rule) => (
                                    <div
                                       key={rule.id}
                                       className="flex items-start gap-3 p-3 rounded-xl border border-neutral"
                                    >
                                       <span
                                       ...
                                       <div className="text-[12px] text-primary space-y-0.5">
                                          ...
                                          {rule.giftProductVariantId && (
                                             <p className="font-mono text-[11px] text-neutral-dark">
                                                Gift:{" "}
                                                {rule.giftProductVariantId}
                                             </p>
                                          )}
                        ...
                        <div className="bg-neutral-light border border-neutral rounded-xl overflow-hidden">
                           <div className="flex items-center gap-2 px-5 py-3.5 border-b border-neutral">
                              ...
                              <span className="text-[12px] font-semibold text-neutral-dark uppercase tracking-wider">
                                 Đối tượng áp dụng ({promotion.targets.length})
                              </span>
                           </div>
                           <div className="p-5 space-y-2">
                              {promotion.targets.length === 0 ? (
                                 ...
                                 promotion.targets.map((target) => (
                                    <div
                                       key={target.id}
                                       className="flex items-center gap-3 p-3 rounded-xl border border-neutral"
                                    >
