...
export default function NewPromotionPage() {
  ...
  const handleSubmit = async (form: PromotionFormData) => {
    ...
    try {
      ...
      setTimeout(() => adminRouter.push(`/promotions/${res.data.id}`), 1200);
    } catch (e: any) {
  ...
  return (
    <div className="min-h-screen bg-neutral-light">
      <div className="flex items-center gap-3 px-6 pt-5 pb-3">
        ...
        <Link href={href("/promotions")} className="text-[13px] text-neutral-dark hover:text-accent transition-colors">
          Khuyến mãi
        </Link>
        <span className="text-neutral-dark text-[13px]">/</span>
      ...
      <div className="px-6 py-4 flex justify-center">
        <div className="w-full">
          ...
          <PromotionForm
            ...
            onCancel={() => adminRouter.push("/promotions")}
