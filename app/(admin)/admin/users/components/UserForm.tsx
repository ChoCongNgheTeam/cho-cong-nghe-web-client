  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-[12px] font-semibold text-primary flex items-center gap-1.5 uppercase tracking-wide">
        ...
        {hint && (
          <span className="text-[11px] text-neutral-dark font-normal normal-case tracking-normal">
            {hint}
          </span>
        )}
      </label>
...
export default function UserForm({ editingUser }: Props) {
  ...
  useEffect(() => {
    if (editingUser) {
      const gender: Gender = GENDERS.includes(editingUser.gender as Gender)
  ...
  const validate = (): boolean => {
    ...
    if (!form.userName.trim()) err.userName = "Nhập username";
      ...
      err.userName = "Chỉ chữ, số và dấu gạch dưới";
    ...
    <div className="space-y-5 p-5 bg-neutral-light min-h-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-1.5 text-[11px] text-neutral-dark mb-0.5">
            <button
              onClick={() => router.push("/admin/users")}
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder={
                      editingUser
                        ? "Nhập mật khẩu mới..."
                        : "Tối thiểu 6 ký tự, có chữ hoa và số"
                    }
