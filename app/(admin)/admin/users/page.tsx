...
export default function UserPage() {
  ...
  const handleToggleActive = async (user: User) => {
    ...
    // optimistic UI
    setUsers((prev) =>
      prev.map((u) => (u.id === user.id ? { ...u, isActive: !oldValue } : u)),
    );
  ...
  // reset page khi search/filter đổi
  useEffect(() => {
    setCurrentPage(1);
  }, [search, filter]);
      ...
      <div className="mx-auto ">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-5 py-2.5 
                         ...
                         active:bg-indigo-800 transition-colors cursor-pointer"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full box-border rounded-lg border border-gray-300 bg-white 
                              pl-10 pr-4 py-2.5 text-sm text-gray-900 
        ...
        <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
          {loading ? (
            ...
            <div className="flex min-h-[400px] items-center justify-center text-lg text-red-600">
              {error}
            </div>
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-6 py-4 text-sm">
                        <div className="flex items-center gap-3 group relative">
                          ...
                          {/* Chỉ hiện select khi hover hoặc focus */}
                          <div className="relative opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-150">
                            <select
                            ...
                            {/* Icon nhỏ để gợi ý có thể click */}
                            <button
                              type="button"
                              disabled={loadingId === user.id}
