...
export function useVariantSelector({ cartItemId, productSlug, currentVariantId, colorLabel, storageLabel, colorValue, currentQuantity, onSuccess, onUpdateItem }: UseVariantSelectorProps) {
  ...
  const fetchVariants = useCallback(
    async (forceRefresh = false) => {
      ...
      try {
        ...
        const res = await apiRequest.get<{ data: VariantOption[] }>(`/products/slug/${productSlug}/variant-options`, opts);
