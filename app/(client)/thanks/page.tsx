          ...
          <div className="px-8 py-10">
            ...
            <div className="mb-8 rounded-2xl p-6 border bg-accent-light border-accent/40">
              <div className="flex items-start gap-4">
                <div className="shrink-0 flex h-12 w-12 items-center justify-center rounded-xl bg-accent">
                  <Package className="w-6 h-6 text-primary-darker" />
                </div>
              ...
              <div className="relative">
                ...
                <div className="flex flex-col gap-6 sm:flex-row sm:gap-4">
                  {[
                    ...
                    >
                      <div className="z-10 mb-3 flex h-12 w-12 items-center justify-center rounded-full shadow-md bg-accent text-primary-darker font-bold">
                        {item.step}
                      </div>
            ...
            <div className="mb-8 rounded-2xl p-6 bg-linear-to-r from-neutral-light to-neutral">
              <div className="mb-3 flex items-center gap-3">
                ...
                <h3 className="font-semibold text-primary">Cần hỗ trợ?</h3>
              </div>
