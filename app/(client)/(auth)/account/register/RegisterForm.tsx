...
const RegisterForm: React.FC<RegisterFormProps> = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e?: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      const response = await apiRequest.post<RegisterResponse>("/auth/register", registerData, { noAuth: true });
      ...
      setFormData({ userName: "", email: "", password: "", confirmPassword: "", fullName: "", phone: "" });
      setAgreeTerms(false);
      ...
      if (error instanceof ApiError) {
        ...
        toast.error(msg.includes("network") || msg.includes("kết nối") ? "Không thể kết nối đến máy chủ. Vui lòng kiểm tra kết nối mạng!" : msg, { title: "Lỗi", duration: 5000, showProgress: true });
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="sm:pl-0 md:pl-8 lg:pl-10 lg:px-0">
      ...
      {errors.general && <div className="mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded-lg text-sm">{errors.general}</div>}
