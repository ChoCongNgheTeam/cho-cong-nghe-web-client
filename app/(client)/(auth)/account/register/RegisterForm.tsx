...
const RegisterForm = () => {
   ...
   return (
      <div className="sm:pl-0 md:pl-8 lg:pl-10 lg:px-0">
         ...
         <form className="space-y-4 sm:space-y-6 md:mt-4">
            <div>
            ...
            <div>
               <label className="block mb-2 text-primary">Số điện thoại</label>
               <div className="relative">
            ...
            <label className="flex items-start cursor-pointer">
               ...
               />
               <span className="text-xs sm:text-sm text-neutral-darker">
