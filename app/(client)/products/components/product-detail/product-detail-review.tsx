        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <div className="flex items-center gap-2 mt-2 sm:mt-0 sm:absolute sm:right-3 sm:top-1/2 sm:-translate-y-1/2">
              ...
              <button className="px-4 sm:px-6 py-2 bg-black text-white rounded-full text-xs sm:text-sm font-medium hover:bg-gray-800 ml-auto">
                Gửi bình luận
              </button>
            </div>
          </div>
                        ...
                        <div key={reply.id} className="flex gap-2 sm:gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1 flex-wrap">
                              ...
                              <span className="px-2 py-0.5 bg-gray-600 text-white text-xs rounded whitespace-nowrap">
                                {reply.role}
                              </span>
                              <span className="text-xs text-gray-500">
                                • {reply.time}
                            ...
                            <p className="text-gray-700 whitespace-pre-line text-xs sm:text-sm break-words">
                              {reply.content}
                            </p>
                          </div>
                        </div>
