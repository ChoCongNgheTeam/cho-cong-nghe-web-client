   ...
   return (
      <div className="w-full">
         ...
         <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm">
            ...
            <span className="text-neutral-darker dark:text-neutral-darker">
               |
            </span>
            <button
               onClick={openDialog}
            ...
            <div className="bg-pink-100 dark:bg-neutral border border-pink-300 dark:border-neutral-dark rounded-lg p-3 sm:p-4 mt-3 sm:mt-4 transition-colors duration-300">
               <div className="flex gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                     <p className="text-xs sm:text-sm mb-1 text-primary transition-colors duration-300">
                        Đặc quyền HSSV - Giáo viên
                     </p>
                     <p className="text-xs sm:text-sm text-primary mb-2 transition-colors duration-300">
                        Giảm ngay 200.000đ
                     </p>
         ...
         <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            <button className="flex-1 sm:flex-[2] bg-promotion hover:bg-promotion-hover dark:bg-promotion dark:hover:bg-promotion-hover text-neutral-light dark:text-primary py-3 rounded-lg transition-colors text-sm sm:text-base cursor-pointer">
               Mua ngay
            </button>
            <button className="flex-1 sm:flex-[2] bg-primary-dark hover:bg-primary-hover dark:bg-primary-light dark:hover:bg-neutral text-neutral-light dark:text-primary py-3 rounded-lg transition-colors text-sm sm:text-base cursor-pointer">
               Trả góp 0%
            </button>
         </div>
