...
export default function NotificationSettingsPage() {
  ...
  const hasUnsaved = local.email !== saved.email || local.push !== saved.push || local.promo !== saved.promo;
  ...
  return (
    <div className="w-full pb-24">
      ...
      <section className="bg-neutral-light border border-neutral rounded-2xl p-4 sm:p-6 space-y-4 mt-4">
        ...
        <p className="text-xs text-neutral-dark">Tần suất tối đa 3 lần/tuần. Bạn có thể tắt bất cứ lúc nào.</p>
      </section>
