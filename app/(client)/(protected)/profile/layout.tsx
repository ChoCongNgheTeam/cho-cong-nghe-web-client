...
import { Package, Bell, FileText, Heart, MapPin, Shield, LogOut } from "lucide-react";
            ...
            <div className="bg-white rounded-lg shadow-sm p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-800">{user?.fullName || "Người dùng"}</h3>
              ...
              <div className="bg-gradient-to-r from-orange-400 via-orange-500 to-red-500 rounded-lg p-4 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xs mb-3 opacity-90">Quét tầm Zalo ChoCongNghe Shop để kích hoạt điểm thưởng</p>
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-3 px-4 py-3 transition-all ${
                        isActive ? "bg-red-50 border-l-4 border-red-600 text-red-600 font-medium" : "hover:bg-gray-50 text-gray-700 border-l-4 border-transparent"
                      }`}
                    >
