...
function ThemeMenuItem({ showChevron = false }: { showChevron?: boolean }) {
   ...
   if (showChevron) {
      ...
      return (
         <button
            onClick={toggleTheme}
            className="w-full flex items-center gap-3 px-4 py-3.5 border-b border-neutral text-primary hover:bg-neutral-light transition-colors cursor-pointer"
         >
                     ...
                     <div className="bg-accent rounded-lg p-4 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                           ...
                           <p className="text-xs mb-3 opacity-90">
                              Quét mã Zalo ChoCongNghe Shop để kích hoạt điểm
                              thưởng
                           </p>
                           <Link
                              href="/membership"
               ...
               {isProfileHome && (
                  <div className="lg:hidden space-y-3">
                     ...
                     <div className="bg-accent rounded-xl p-4 text-white relative overflow-hidden">
                        ...
                        <p className="text-xs mb-0.5 opacity-90">
                           Quý khách chưa là
                        </p>
