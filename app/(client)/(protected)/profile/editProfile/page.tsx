...
export default function ProfileForm() {
  ...
  // snapshot để so sánh dirty state
  ...
  const [initialDob, setInitialDob] = useState<Dob>({
    day: "",
    month: "",
    year: "",
  });
  ...
  if (loading) {
    return <div className="p-4 text-primary">Đang tải...</div>;
  }

  if (!user) {
    return <div className="p-4 text-primary">Bạn chưa đăng nhập</div>;
  }
        ...
        <div className="px-4 py-10  rounded-2xl">
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="px-6 py-8 space-y-5">
              ...
              {/* Submit — disable khi chưa có thay đổi */}
              <div className="pt-2">
                <button
                  type="submit"
