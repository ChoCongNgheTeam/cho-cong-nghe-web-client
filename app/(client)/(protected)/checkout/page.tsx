...
export default function CheckoutPage() {
   ...
   // ── 4. Thay toàn bộ hàm handlePlaceOrder ──────────────────────

   // ── 5. Handler khi user xác nhận đã thanh toán / xem đơn ──────
   ...
   const displayVoucherDiscount =
      previewData?.voucherDiscount ?? appliedVoucherValue;
                        ...
                        <div className="px-4 pb-4 text-xs text-neutral-darker space-y-1 border-t border-neutral pt-3">
                           <div className="flex justify-between">
                              ...
                              >
                                 {previewData.shippingFee === 0
                                    ? "Miễn phí"
                                    : formatPrice(previewData.shippingFee)}
                              </span>
                           </div>
                           <div className="flex justify-between">
