...
import AddressSidebar, { ApiAddress } from "./components/address/AddressSidebar";
...
import { Province, Ward, UserProfile, SavedAddress, CartItem, SelectedItem, CheckoutData, PreviewData, ShippingSectionProps } from "./_lib";
...
export default function CheckoutPage() {
  ...
  const amountAfterDiscount = Math.max(0, subtotal - resolvedPromotionDiscount - voucherValue);
      ...
      <CartBottomBar
        ...
        summaryRows={[
          ...
          },
          {
            ...
            value: shippingFee != null ? formatVND(shippingFee) : "Chọn địa chỉ",
          },
          {
