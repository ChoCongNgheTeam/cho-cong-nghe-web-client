    ...
    <div className="space-y-4">
      {savedAddresses.length > 0 && (
        <button
          ...
          className="text-sm text-gray-500 hover:text-black flex items-center gap-1 transition-colors cursor-pointer"
        >
          ← Dùng địa chỉ đã lưu
        </button>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            className={`${inputCls} ${
              touchedName && nameHasDigit(contactName) ? "border-red-400" : ""
            }`}
            value={contactName}
