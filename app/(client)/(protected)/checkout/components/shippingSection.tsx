...
import { Loader2, MapPin, Plus, Pencil, ChevronRight } from "lucide-react";
...
export default function ShippingSection({
        ...
        {savedAddresses.map((addr) => (
          ...
          >
            ...
            {selectedSavedAddress?.id === addr.id && (
              <button
                type="button"
                onClick={(e) => { e.preventDefault(); onEditAddress(); }}
  ...
  // ─── Manual form (2-column grid layout matching screenshot) ─────────────
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            className={`${inputCls} ${
              touchedPhone && !isValidPhone(contactPhone) ? "border-red-400" : ""
            }`}
            value={contactPhone}
