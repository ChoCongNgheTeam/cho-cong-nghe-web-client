            ...
            {items.length === 0 ? (
               ...
               <div className="grid gap-4 lg:grid-cols-3">
                  ...
                  <div className="lg:col-span-2 space-y-4">
                     <div className="flex items-center justify-between rounded-lg bg-neutral-light px-4 py-3 border border-neutral min-h-13">
                           ...
                           >
                              <div className="flex gap-4 items-center">
                                 ...
                                 <div className="flex flex-1 flex-col sm:flex-row sm:justify-between gap-3">
                                    <div className="flex-1 min-w-0">
                                       <div className="flex items-start justify-between gap-2 mb-1">
                                          ...
                                          <button
                                             ...
                                             className="sm:hidden shrink-0 text-neutral-darker transition hover:text-primary cursor-pointer"
                                    ...
                                    {/* Desktop price */}
                                    <div className="hidden sm:flex items-center gap-2 lg:gap-4 shrink-0 flex-wrap justify-end">
                                       <div className="flex flex-col items-end w-24 lg:w-28 shrink-0">
