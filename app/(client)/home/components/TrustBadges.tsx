      ...
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-sm text-primary">Nhập khẩu, bảo hành chính hãng</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-sm text-primary">Theo chính sách đổi trả tại ChoCongNghe</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-sm text-primary">Đảm bảo tương thích và độ bền cao</p>
          </div>
        </div>
      </div>
    </section>
