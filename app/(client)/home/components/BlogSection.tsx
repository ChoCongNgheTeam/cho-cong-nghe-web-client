...
export default function BlogSection({ blogs }: BlogSectionProps) {
  ...
  const BlogCard = ({ blog, isTall = false }: { blog: BlogDTO; isTall?: boolean }) => (
    <Link
      href={`/blog/${blog.slug}`}
      className="group relative flex flex-col bg-neutral-light rounded-xl shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden"
    >
      {/* Blog Image */}
      <div className={`relative ${isTall ? 'h-[720px]' : 'h-[230px]'} overflow-hidden bg-gradient-to-br from-neutral-light-active to-neutral-hover`}>
        <Image
          src={blog.thumbnail}
          alt={blog.title}
          fill
        ...
        {/* Gradient Overlay - luôn hiển thị nhẹ */}
        ...
        <div className="absolute inset-x-0 bottom-0 p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
          ...
          <div className="flex items-center gap-2 mb-2">
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-promotion-light-active to-orange-500 flex items-center justify-center">
          ...
          {/* Title */}
          <h3 className={`${isTall ? 'text-lg' : 'text-sm'} font-bold text-neutral-light mb-2 line-clamp-2 leading-tight`}>
            {blog.title}
          </h3>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 text-xs text-neutral-light/90">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="font-semibold">{formatViews(blog.view_count)}</span>
              </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-primary-light-hover">Tin tức và đánh giá sản phẩm mới nhất</p>
          </div>
