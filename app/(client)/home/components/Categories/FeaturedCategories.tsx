...
import { FeaturedCategory } from "../../_libs/index";
    ...
    <section className="py-4 md:py-6 bg-linear-to-b">
      <div className="container">
        <div className="bg-neutral-light rounded-3xl border-2 border-neutral p-6 md:p-8">
          ...
          <Slidezy items={{ mobile: 4, tablet: 6, desktop: 8 }} gap={12} speed={300} loop={false} nav={false} controls={true} slideBy={2} draggable={true}>
            {featuredCategories.map((category) => (
              <Link key={category.id} href={`/category/${category.slug}`} className="group/item block">
