         ...
         <div className="relative z-10 grid grid-cols-2 items-center h-full pl-[12%] px-[8%] gap-[3%]">
          ...
          >
            ...
            Đang Hot
               ...
               {/* Title */}
               <h2
                  className="font-extrabold leading-[1.05] tracking-wider text-white text-[clamp(18px,3.6vw,56px)]"
                  style={textStyle(1)}
               >
                  {slide.title}
               </h2>
               ...
               <p
                  key={`sub-${current}`}
                  className="text-slate-400 leading-relaxed max-w-[34ch] text-[clamp(10px,1.1vw,17px)] mb-4 md:mb-[clamp(12px,2.2vw,30px)] mt-2"
                  style={textStyle(2)}
               >
                  {slide.subTitle}
               </p>
