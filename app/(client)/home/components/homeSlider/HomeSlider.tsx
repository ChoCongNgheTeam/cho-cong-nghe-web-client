      ...
      <div className="relative w-full overflow-hidden aspect-video md:aspect-[21/8] bg-slate-950">
         ...
         <div className="relative z-10 grid grid-cols-2 items-center h-full px-[6%] gap-[4%]">
            ...
            <div className="flex flex-col">
               ...
               <h2
                  key={`title-${current}`}
                  className="font-extrabold leading-[1.05] tracking-tight text-white text-[clamp(18px,3.6vw,56px)] mb-2 md:mb-[clamp(8px,1.4vw,16px)]"
                  style={textStyle(1)}
               >
                  {slide.title}
               </h2>
               ...
               <p
                  key={`sub-${current}`}
                  className="text-slate-400 leading-relaxed max-w-[34ch] text-[clamp(10px,1.1vw,17px)] mb-4 md:mb-[clamp(12px,2.2vw,30px)]"
                  style={textStyle(2)}
               >
         ...
         >
            <svg
               className="w-[clamp(12px,1.2vw,17px)] h-[clamp(12px,1.2vw,17px)]"
               viewBox="0 0 24 24"
               fill="none"
               stroke="currentColor"
               strokeWidth={2}
         ...
         <div className="absolute bottom-[clamp(8px,1.6vw,18px)] left-1/2 -translate-x-1/2 z-20 flex items-center gap-2">
            {sliders.map((_, i) => (
               <button
                  ...
                  className={[
                     "h-1.5 rounded-full border-none cursor-pointer transition-all duration-300",
                     i === current
                        ? "w-6 bg-orange-500"
