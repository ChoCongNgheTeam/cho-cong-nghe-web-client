         ...
         <div className="container px-4">
            ...
            >
               {bannersTop.map((banner) => (
                  ...
                  >
                     <div className="relative aspect-16/6 overflow-hidden bg-linear-to-br from-slate-900 to-slate-800">
                        {banner.imageUrl && (
                           <Image
                              src={banner.imageUrl}
                              alt={banner.title}
                     ...
                     <div className="absolute inset-0 flex flex-col justify-end p-3 md:p-5">
                        <h3 className="text-xl md:text-3xl lg:text-4xl font-black text-neutral-light mb-3 drop-shadow-lg transform transition-transform duration-500 group-hover:translate-x-2">
                           {banner.title}
                        </h3>
