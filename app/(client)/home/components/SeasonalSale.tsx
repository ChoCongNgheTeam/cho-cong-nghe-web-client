        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {SEASONAL_BANNERS.map((banner, index) => (
              ...
              >
                <div className={`relative aspect-square bg-gradient-to-br ${banner.bgColor}`}>
                  {/* Background Image */}
                    ...
                    <div>
                      ...
                      {banner.features && (
                        <div className="space-y-1">
                          {banner.features.slice(0, 3).map((feature, i) => (
                            <div key={i} className="flex items-center gap-1.5">
                              <div className="w-1 h-1 bg-neutral-light rounded-full flex-shrink-0" />
          ...
          >
            <div className={`relative aspect-square bg-gradient-to-br ${LARGE_BANNER.bgColor}`}>
              {/* Background Image */}
              <Image
                ...
                <div className="text-center max-w-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-8">
                    {LARGE_BANNER.features.map((feature, i) => (
                      <div key={i} className="bg-neutral-light/10 backdrop-blur-sm rounded-lg p-3 md:p-4 border border-neutral-light/20">
                        <p className="text-neutral-light text-sm md:text-base font-bold">{feature}</p>
                      </div>
                    ))}
                  </div>
