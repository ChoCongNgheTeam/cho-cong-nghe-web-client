...
export default function DoubleBanner({ banners }: DoubleBannerProps) {
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-6">
          {banners.map((banner, index) => (
            ...
            >
              {/* Image Container */}
              <div className="relative aspect-[16/9] md:aspect-[16/8] overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800">
                <Image
