...
import { getActiveCampaigns, getBannersSection1, getBannersTop, getBestSellingProducts, getBlogs, getFeaturedCategories, getFeaturedProducts, getFlashSaleProducts, getHomeSliders } from "./_libs";
export default async function HomePage() {
  const [sliders, featuredCategories, bannersTop, flashSaleProducts, featuredProducts, hotProducts, activeCampaigns, bannersSection1, blogsData] = await Promise.all([
    getHomeSliders(),
