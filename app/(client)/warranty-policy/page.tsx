        ...
        <div className="flex gap-5">
          ...
          >
            ...
            <p
              ...
              style={{ color: "rgb(var(--primary))" }}
            >
              Tất cả sản phẩm tại ChoCongNghe kinh doanh đều là sản phẩm chính
              hãng và được bảo hành theo đúng chính sách của nhà sản xuất(*).
              Ngoài ra ChoCongNghe cũng hỗ trợ gửi bảo hành miễn phí giúp
              khách hàng đối với cả sản phẩm do ChoCongNghe bán ra và sản phẩm
              Quý khách mua tại các chuỗi bán lẻ khác.
            </p>
            ...
            <ul className="mb-6 space-y-2">
              {[
                <>
                  Bảo hành đổi sản phẩm mới ngay tại shop trong 30 ngày nếu có
                  lỗi NSX.(**)
                </>,
                <>Gửi bảo hành chính hãng không mất phí vận chuyển.(***)</>,
                <>
                  Theo dõi tiến độ bảo hành nhanh chóng qua kênh hotline hoặc
                  tự tra cứu{" "}
                  <Link
                    href="#"
                ...
                <>
                  Hỗ trợ làm việc với hãng để xử lý phát sinh trong quá trình
                  bảo hành.
                </>,
              ].map((item, i) => (
                <li
            ...
            <p
              ...
              style={{ color: "rgb(var(--primary))" }}
            >
              Bên cạnh đó Quý khách có thể tham khảo một số các trường hợp
              thường gặp nằm ngoài chính sách bảo hành sau để xác định sơ bộ
              máy có đủ điều kiện bảo hành hãng:
            </p>
            ...
            <ul className="mb-6 space-y-2">
              {[
                <>
                  Sản phẩm hết hạn bảo hành (Vui lòng tra cứu thời hạn bảo
                  hành sản phẩm{" "}
                  <Link
                    href="#"
            ...
            <ul className="mb-6 space-y-2">
              {[
                ...
                <>
                  Để tìm hiểu thông tin chi tiết về chính sách bảo hành cho sản
                  phẩm cụ thể, xin liên hệ bộ phận Chăm sóc Khách hàng của
                  ChoCongNghe{" "}
