      ...
      <>
         ...
         <Section title="5. Chi tiết cách thức và thể lệ tham gia chương trình tại ChoCongNghe">
            ...
            <div className="space-y-2 mb-5">
               {[
                  {
                     range: "Đơn dưới 1.000.000đ",
                     desc: "Giảm tối đa 200.000đ (tương đương 20.000 điểm)",
                  },
                  {
                     range: "Đơn từ 1.000.000đ trở lên",
            ...
            <ol className="space-y-3 mb-5">
               {[
                  <>
                     Mua hàng tại chuỗi cửa hàng ChoCongNghe. Mỗi lần mua hàng
                     với hóa đơn từ <strong>4.000đ</strong>, khách hàng tích lũy
                     được 01 điểm thưởng tương ứng.
                  </>,
                  <>
                     Tìm kiếm từ khóa <strong>"ChoCongNghe"</strong> trên ứng
                     dụng Zalo hoặc quét mã QR để theo dõi tài khoản Zalo chính
                     thức của ChoCongNghe.
                  </>,
            ...
            <div className="rounded-lg p-4 bg-neutral-light-active border border-neutral">
               ...
               <div className="space-y-3">
                  <SubSection label="Mua trên website">
                     Chọn sản phẩm → thêm vào giỏ hàng → tại màn hình giỏ hàng
                     bật toggle đổi điểm → điểm được quy đổi thành ưu đãi giảm
                     giá → xác nhận và thanh toán.
                  </SubSection>
                  <SubSection label="Mua qua tổng đài hoặc tại cửa hàng">
                     Liên hệ nhân viên shop hoặc nhân viên tư vấn để được hỗ trợ
                     trực tiếp.
                  </SubSection>
               </div>
            </div>
         ...
         <Section title="6. Các quy định khác">
            ...
            <ul className="space-y-2">
               {[
                  ...
                  <>
                     Tất cả các thắc mắc và khiếu nại về chương trình, vui lòng
                     liên hệ với chúng tôi qua hotline:{" "}
                     <strong>1800.6060</strong> hoặc <strong>1800.6626</strong>{" "}
                     (miễn phí).
                  </>,
               ].map((item, i) => (
                  <li
