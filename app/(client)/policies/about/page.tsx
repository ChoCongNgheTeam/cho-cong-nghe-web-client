...
export default function About() {
  return (
    <div className="text-primary leading-relaxed mb-10 w-full">
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div
            ...
            style={{
              background: "linear-gradient(180deg, #0c1a3a 0%, #0f2050 35%, #1a3580 100%)",
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {[
            ...
            <div key={item.title} className="rounded-lg border border-neutral-light bg-neutral-light/20 p-4">
      ...
      <section className="mb-8">
        <h2 className="font-bold text-primary mb-4">3. Dành cho khách hàng & quản trị viên</h2>
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-neutral-light bg-neutral-light p-4">
