            ...
            <main className="p-6 md:p-8">
               ...
               <Section title="2. Chính sách giao hàng">
                  <div className="rounded-lg overflow-hidden border border-neutral mb-4">
                     <div className="grid grid-cols-3 font-semibold px-4 py-2.5 bg-neutral-light-active border-b border-neutral text-primary" style={{ fontSize: "12px" }}>
                        <span>Tiêu chí</span>
                        <span>Điều kiện</span>
                        <span>Chi phí</span>
                     </div>
               ...
               <Section title="3. Chính sách lắp đặt">
                  ...
                  <div className="rounded-lg overflow-hidden border border-neutral mb-4">
                     <div className="grid grid-cols-4 font-semibold px-4 py-2.5 bg-neutral-light-active border-b border-neutral text-primary" style={{ fontSize: "12px" }}>
                     ...
                     <div className="divide-y divide-neutral">
                        {[
                           ...
                           <div key={i} className="grid grid-cols-4 px-4 py-3 gap-2 items-start">
                              {i === 0 && (
                                 <span className="font-semibold text-promotion row-span-3" style={{ fontSize: "12px" }}>
                                    Lắp đặt tiêu chuẩn (miễn phí)
                                 </span>
                              )}
                              {i !== 0 && <span />}
                              <span className="text-primary" style={{ fontSize: "12px" }}>{row.product}</span>
                              <span className="text-primary-light" style={{ fontSize: "12px" }}>{row.condition}</span>
                              {i === 0 && <span className="font-semibold text-promotion" style={{ fontSize: "12px" }}>Miễn phí</span>}
                              {i !== 0 && <span />}
                           </div>
                        ))}
                     </div>
                     ...
                     <div className="border-t border-neutral divide-y divide-neutral">
                        {[
                           ...
                           <div key={i} className="grid grid-cols-4 px-4 py-3 gap-2 items-start">
                              {i === 0 && (
                                 <span className="font-semibold text-primary-light" style={{ fontSize: "12px" }}>
                                    Lắp đặt nâng cao (có tính phí)
                                 </span>
                              )}
                              {i !== 0 && <span />}
                              <span className="text-primary font-medium" style={{ fontSize: "12px" }}>{row.product}</span>
                              <ul className="space-y-1">
                                 {row.conditions.map((c, j) => (
                                    <li key={j} className="flex gap-1 text-primary-light" style={{ fontSize: "12px" }}>
                              ...
                              {i === 0 && (
                                 <span className="text-primary-light" style={{ fontSize: "12px" }}>
                                    KH chịu phí phát sinh (thỏa thuận với đơn vị thi công)
                                 </span>
                              )}
                              {i !== 0 && <span />}
                           </div>
                  ...
                  <div className="rounded-lg overflow-hidden border border-neutral">
                     ...
                     <div className="divide-y divide-neutral">
                        {[
                           ...
                           <div key={i} className="grid grid-cols-4 px-4 py-3 gap-2 items-start">
                              {i === 0 && (
                                 <span className="font-semibold text-promotion" style={{ fontSize: "12px" }}>
                                    Lắp đặt tiêu chuẩn (miễn phí)
                                 </span>
                              )}
                              {i !== 0 && <span />}
