      ...
      <div className="min-h-screen">
         <div className="container py-5">
            <main className="p-6 md:p-8">
               <h1 className="font-bold mb-6 text-primary text-center" style={{ fontSize: "24px" }}>
                  Chính sách đổi trả
               </h1>
               ...
               <Section title="Khung chính sách đổi trả">
                  ...
                  <div className="mt-5 rounded-lg p-4 bg-neutral-light-active border border-neutral">
                     ...
                     <p className="leading-relaxed text-primary-light">
                        ...
                        <strong className="text-primary">1 năm</strong>. Bảo hành mở rộng có sẵn cho hầu hết các sản phẩm với mức phí nhỏ.
                     </p>
                  </div>
               </Section>
                  ...
                  <div className="space-y-2">
                     {[
                        ...
                        <div key={i} className="flex items-center gap-3 rounded-lg px-4 py-3 bg-neutral-light-active border border-neutral">
                           <span className="font-bold px-2.5 py-1 rounded-full shrink-0 bg-promotion-light text-promotion" style={{ fontSize: "12px" }}>
                              {item.range}
                           </span>
                  ...
                  <ul className="space-y-2">
                     {[
                        ...
                        <li key={i} className="flex gap-2 leading-relaxed text-primary">
                           <span className="mt-0.5 w-4 h-4 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion-light text-promotion" style={{ fontSize: "11px" }}>
                              ✓
                           </span>
                           {item}
                        </li>
                  ...
                  <ol className="space-y-3">
                     {[
                        ...
                        <li key={i} className="flex items-center gap-3 text-primary">
                           <span className="w-6 h-6 rounded-full flex items-center justify-center shrink-0 font-bold bg-promotion text-white" style={{ fontSize: "12px" }}>
                              {i + 1}
                           </span>
                           {step}
                           {i < 4 && <span className="ml-auto text-neutral-dark text-xs">→</span>}
                        </li>
                     ))}
                  </ol>
               </Section>
               ...
               <Section title="Phí đổi trả">
                  <div className="space-y-2">
                     {[
                        ...
                        <div key={i} className="flex items-center justify-between rounded-lg px-4 py-3 bg-neutral-light-active border border-neutral">
                           ...
                           <span className={`font-semibold ${row.highlight ? "text-promotion" : "text-primary-light"}`}>
                              {row.fee}
                           </span>
                        </div>
                     ))}
                  ...
                  <p className="mt-4 leading-relaxed text-primary-light">
                     ...
                     <Link href="#" className="font-medium text-promotion hover:text-promotion-hover transition-colors">
                        Tài khoản của tôi
                     </Link>.
                  </p>
               </Section>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
   return (
      <section className="mb-6">
         <h2 className="font-bold mb-3 text-primary" style={{ fontSize: "15px" }}>{title}</h2>
         {children}
      </section>
   );
}
