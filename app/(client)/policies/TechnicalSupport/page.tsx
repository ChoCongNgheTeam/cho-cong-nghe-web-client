   ...
   return (
      <div className="min-h-screen">
         ...
         <ul className="space-y-3">
            {[
               <>
                  Để bảo vệ dữ liệu cá nhân, Quý khách vui lòng sao lưu và{" "}
                  <strong>XOÁ các dữ liệu cá nhân</strong> trước khi bàn giao
                  sản phẩm cho nhân viên ChoCongNghe.
               </>,
               ...
               <>
                  Nếu chưa có tài khoản iCloud, Quý khách liên hệ nhân viên kỹ
                  thuật để được hỗ trợ tạo{" "}
                  <strong>Tài khoản iCloud (Apple ID) / Google</strong> và các
                  tài khoản khác <strong>miễn phí</strong> tại cửa hàng. Đồng
                  thời yêu cầu nhân viên cung cấp thông tin, mật khẩu tài khoản
                  vừa được tạo trước khi rời cửa hàng.
               </>,
            ].map((item, i) => (
