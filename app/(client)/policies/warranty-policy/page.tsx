         ...
         <div className="container py-5">
            <main className="p-6 md:p-8">
               ...
               <ul className="mb-6 space-y-2">
                  {[
                     ...
                     <>
                        ...
                        <Link href="#" className="font-medium text-promotion hover:text-promotion-hover transition-colors">Tại đây</Link>.
                     </>,
               ...
               <ul className="mb-6 space-y-2">
                  {[
                     <>
                        Sản phẩm hết hạn bảo hành (Vui lòng tra cứu thời hạn bảo hành sản phẩm{" "}
                        <Link href="#" className="font-medium text-promotion hover:text-promotion-hover transition-colors">Tại đây</Link>).
                     </>,
               ...
               <ul className="mb-6 space-y-2">
                  {[
                     ...
                     <>
                        Để tìm hiểu thông tin chi tiết về chính sách bảo hành cho sản phẩm cụ thể, xin liên hệ bộ phận Chăm sóc
                        Khách hàng của ChoCongNghe <span className="font-semibold">1800 6616</span>.
                     </>,
                     <>
