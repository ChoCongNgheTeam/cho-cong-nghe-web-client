...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: "Người dùng",
    icon: Users,
    items: [{ title: "Danh sách người dùng", href: "/admin/users", icon: Users }],
  },
  {
    label: "Nội dung",
    icon: BookOpen,
        ...
        <div className={`border-b border-neutral flex items-center justify-between ${collapsed ? "px-2 py-3" : "px-3 py-3"}`}>
          ...
          {collapsed && (
            <Link href="/admin/dashboard" className="mx-auto">
              <Image src="/logo.png" alt="Logo" width={32} height={32} className="h-7 w-auto object-contain" priority />
            </Link>
          )}
