...
export default function OrderSummary({
  ...
  return (
    <div className="rounded-lg bg-neutral-light shadow-sm sticky top-4 ">
      <div className="p-4 space-y-3">
        ...
        {onOpenVoucherModal && (
          <div className="rounded-lg bg-neutral-light shadow-sm overflow-hidden">
            <button onClick={onOpenVoucherModal} className="flex w-full items-center justify-between p-3 transition hover:bg-accent-light group border-b border-neutral cursor-pointer">
