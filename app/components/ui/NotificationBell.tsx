...
export default function NotificationBell({ variant = "user", footerHref, footerLabel, headerLabel }: NotificationBellProps) {
  ...
  const resolvedFooterLabel = footerLabel ?? (variant === "admin" ? "Xem tất cả thông báo" : "Xem tất cả thông báo");
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      >
        <Bell className="w-5 h-5 lg:w-6 lg:h-6 text-primary" strokeWidth={2.3} />
        {unreadCount > 0 && (
          <span
