  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed p-2 bottom-20 lg:bottom-6 right-2 sm:right-4 z-49 w-auto h-10 rounded-xl bg-accent hover:bg-accent-hover active:bg-accent-active text-white flex items-center justify-center shadow-lg transition-all duration-300 cursor-pointer ${
