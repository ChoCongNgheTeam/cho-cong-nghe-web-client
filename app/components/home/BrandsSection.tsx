        ...
        <div className="grid grid-cols-4 md:grid-cols-8 gap-4">
          {brands.map((brand) => (
            <a key={brand.id} href={`#${brand.slug}`} className="text-center group cursor-pointer">
              <div className="w-full aspect-square bg-linear-to-br rounded-lg mb-2 flex items-center justify-center group-hover:shadow-xl transition-all group-hover:scale-105">
