   ...
   />
                  ...
                  <div>
                     ...
                     >
                        ...
                        <ChevronDown
                           className={`w-5 h-5 md:hidden transition-transform ${openSections.hotline ? "rotate-180" : ""}`}
                        />
                     </button>
                     <div
                        className={`space-y-1.5 text-[11px] sm:text-sm ${openSections.hotline ? "block" : "hidden md:block"}`}
                     >
                        <div>
               ...
               <div>
                  ...
                  <ul
                     className={`space-y-1 text-[11px] sm:text-sm text-gray-300 ${openSections.about ? "block" : "hidden md:block"}`}
                  >
                     {[
                        {
               ...
               <div>
                  ...
                  <ul
                     className={`space-y-1 text-[11px] sm:text-sm text-gray-300 ${openSections.policy ? "block" : "hidden md:block"}`}
                  >
                     {[
                        {
