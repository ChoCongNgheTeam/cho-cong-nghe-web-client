...
//     "--header-translate",
//     isVisible ? "0px" : `-${headerRef.current?.offsetHeight ?? 64}px`
//   );
// }, [isVisible]);
 ...
 useEffect(() => {
    ...
    const setHeaderVars = (visible: boolean) => {
      const h = headerRef.current?.offsetHeight ?? 64;
      document.documentElement.style.setProperty("--header-visible", visible ? "1" : "0");
      document.documentElement.style.setProperty("--header-translate", visible ? "0px" : `-${h}px`);
    };
